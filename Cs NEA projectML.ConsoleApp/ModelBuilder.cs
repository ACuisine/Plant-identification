...
using Cs_NEA_projectML.Model;
using Microsoft.ML.Vision;

namespace Cs_NEA_projectML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Andre\AppData\Local\Temp\c8723db0-cdae-47c4-ae8e-e43db22dc791.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Andre\AppData\Local\Temp\MLVSTools\Cs NEA projectML\Cs NEA projectML.Model\MLModel.zip";
